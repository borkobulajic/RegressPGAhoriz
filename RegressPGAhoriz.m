% AN EXAMPLE - Multiple linear regression analysis for the horizontal PGA values
%
% Inputs:
...
% 2) HorizPGAdata.mat - containing a variable HorizPGA with twice as 203 rows
%   and 1 column. The first 203 rows consist of the horizontal PGA values
%   in one orthogonal horizontal direction and the next 203 rows consist of the
%   corresponding horizontal PGA values in the other orthogonal horizontal direction.
%
% Outputs:
% 1) ScallingCoefficientsHORIZ.mat - containing the input variables MRSGSL and HorizPGA, 
...
load MRSGSLdata.mat
load HorizPGAdata.mat

% EPICENTRAL DISTANCE, THE DATA FOR ALL DISTANCES
DistanceBound=1000;
SourceToSiteDistance=1;
ScallingCoefficientsEPICallR=regressionBB2020horiz(MRSGSL,HorizPGA,DistanceBound,SourceToSiteDistance,1);

% HYPOCENTRAL DISTANCE, THE DATA FOR ALL DISTANCES
DistanceBound=1000;
SourceToSiteDistance=2;
ScallingCoefficientsHYPOCallR=regressionBB2020horiz(MRSGSL,HorizPGA,DistanceBound,SourceToSiteDistance,1);

% EPICENTRAL DISTANCE, THE DATA FOR EPICENTRAL DISTANCES SMALLER THAN 30km
DistanceBound=30;
SourceToSiteDistance=1;
ScallingCoefficientsEPICsmallerthan30km=regressionBB2020horiz(MRSGSL,HorizPGA,DistanceBound,SourceToSiteDistance,1);

% HYPOCENTRAL DISTANCE, THE DATA FOR EPICENTRAL DISTANCES SMALLER THAN 30km
DistanceBound=30;
SourceToSiteDistance=2;
ScallingCoefficientsHYPOCsmallerthan30km=regressionBB2020horiz(MRSGSL,HorizPGA,DistanceBound,SourceToSiteDistance,1);

clear DistanceBound SourceToSiteDistance
save ScallingCoefficientsHORIZ.mat
